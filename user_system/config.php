...
require_once __DIR__ . '/../vendor/autoload.php'; // 引入Composer安装的库

$dotenv = Dotenv\Dotenv::createImmutable(__DIR__); // 找到当前目录里的.env文件
$dotenv->load(); // 把.env文件中写的内容加载到 PHP 的环境变量中
